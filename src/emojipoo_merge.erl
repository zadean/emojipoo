...
loop(IXA, IXB, Out, IsLastLevel, [{Key1, Value1} | AT], [{Key2, _Value2} | _IX] = BKVs, From) when
    Key1 < Key2
->
...
loop(IXA, IXB, Out, IsLastLevel, [{Key1, _Value1} | _AT] = AKVs, [{Key2, Value2} | IX], From) when
    Key1 > Key2
->
